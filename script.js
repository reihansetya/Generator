...
add.addEventListener('click', function(){
    ...
    if (txt == ''){
        ...
        function txtIsi() {
            txtArea.append(`${txt}...... ${txt} ❤ ❤ ❤ WANGY WANGY WANGY WANGY WANGY WANGY HU HA HU HA HU HA, aaaah baunya ${txt} wangi aku mau nyiumin aroma ${txtW} ${txt} AAAAAAAAH ~~ ${txtW}.... aaah ${txtW} juga pengen aku elus-elus ~ AAAAAH |${txt} ❤ ❤ ❤ manis banget AAAAAAAAH
${txtW} ${txt} BEGITU MENGGODAAAAAAAAA............ GUA RELA JADI BUDAK SIMP HANYA DEMI ${txtW} ${txt} TERDJINTA AAAAAAAAAAAAAAAAAAAAAAAAAAAAAGH
apa ? ${txt} itu gak nyata ? Cuma karakter 2 dimensi katamu ? nggak, ngak ngak ngak ngak NGAAAAAAAAK GUA GAK PERCAYA ITU DIA NYATA !! GUA GAK PEDULI SAMA KENYATAAN POKOKNYA GAK PEDULI. ${txt} ngeliat gw ... ${txt} NGELIATIN GW! ${txt}... kamu percaya sama aku ? aaaaaaaaaaah syukur ${txt} gak malu memiliki aku aaaaaah ❤ ❤ ❤ YEAAAAAAAAAAAH GUA MASIH PUNYA ${txt}, ${txt} AKU SAYANG ${txt} AKU CINTA ${txt} AKU AKU INGIN ${txt} MENJADI BIDADARIKUUUUUUU!!!!!!!!!!!!!
`);
        }
        if(txtAreaFull != ''){
